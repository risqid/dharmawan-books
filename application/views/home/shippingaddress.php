...
<div class="container-fluid">
	...
	<div class="row">
		<div class="col-lg-6">			
			...
			<form action="<?= base_url('home/orderinformation'); ?>" method="post">
				...
				<div class="form-group">
					...
					<input type="text" class="form-control" id="city" name="city" value="<?= $address['city']; ?>" placeholder="masukkan kota / kabupaten" required readonly>
					<?= form_error('city','<small class="text-danger pl-3">','</small>'); ?>
				</div>
				<div class="form-group">
					<label for="province">Province</label>
					<input type="text" class="form-control" id="province" name="province" value="<?= $address['province']; ?>" placeholder="masukkan provinsi" required readonly>
					<?= form_error('province','<small class="text-danger pl-3">','</small>'); ?>
				</div>
				<div class="form-group">
					<label for="country">Country</label>
					<input type="text" class="form-control" id="country" name="country" value="<?= $address['country']; ?>" placeholder="masukkan negara" required readonly>
				...
				<input type="hidden" class="form-control" id="shipping_address_id" name="shipping_address_id" value="<?= $address['id']; ?>">
